    ...
    return (
        <SafeAreaView style={{ backgroundColor: "#F1F1F", height: "100%" }}>
            ...
            <View style={styles.subdivOne}>
                ...
                <Text style={{ fontFamily: "Lexend-Regular", color: "white", fontSize: RFValue(22), marginStart: "15%" }}>Address</Text>
            </View>
            <ScrollView style={{ height: "80%" }}>
                ...
                <View style={{ width: "95%", borderRadius: 20, backgroundColor: COLORS.white, margin: "2%", marginTop: "5%", borderColor: COLORS.element,borderWidth:1 }}>
                        ...
                        <View style={{ flexDirection: "column", width: "90%", }}>
                            <View style={{ flexDirection: "row",width:"100%" }}>
                                ...
                                <TouchableOpacity style={{ width: "15%", justifyContent: "center", alignItems: "center", marginStart: "2%", }}>
                                    <Text style={{width:"100%", color: COLORS.gray, fontSize: RFValue(11), ...FONTS.lexendregular, borderRadius: 1, borderWidth: 1, borderColor: COLORS.gray, paddingHorizontal: "5%" }}>Home</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                        <View style={{ flexDirection: "column", width: "10%", borderRadius: 5, justifyContent: "flex-start", alignItems: "center", alignSelf: "flex-end", backgroundColor: COLORS.element, padding: "1%" }}>

                            <Entypo name="edit" size={20} color={COLORS.white} style={{ marginTop: "10%" }} />
                        </View>
                        ...
                        <View style={{ flexDirection: "column", width: "90%", }}>
                            <View style={{ flexDirection: "row" }}>
                                ...
                                <TouchableOpacity style={{ width: "25%", justifyContent: "center", alignItems: "center", marginStart: "2%", }}>
                                    <Text style={{ color: COLORS.gray, fontSize: RFValue(11), ...FONTS.lexendregular, borderRadius: 1, borderWidth: 1, borderColor: COLORS.gray, paddingHorizontal: "5%" }}>Work</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                        <View style={{ flexDirection: "column", width: "10%", borderRadius: 5, borderWidth: 1, justifyContent: "flex-start", alignItems: "center", alignSelf: "flex-end", backgroundColor: COLORS.white, padding: "1%" }}>

                            <Entypo name="edit" size={18} color={COLORS.black} style={{ marginTop: "10%" }} />
                        </View>
            ...
            <View style={{ flexDirection: "column", width: "55%", marginHorizontal: "3%", marginVertical: "4%",}} onPress={()=>navigation.navigate("Delivery")}>
                ...
                <TouchableOpacity style={{ flexDirection: "column", width: "35%", marginHorizontal: "3%", marginVertical: "1%", borderRadius: 5, borderWidth: 1, justifyContent: "center", alignItems: "center" }} >
