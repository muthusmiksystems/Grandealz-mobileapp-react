    ...
    return (
        ...
        <View style={{ width: "100%", borderRadius: moderateScale(20), backgroundColor: COLORS.white, alignSelf: "center", marginVertical: verticalScale(20) }}>
            <View style={{ width: "100%", borderRadius: 18, padding: "3%", backgroundColor: COLORS.white }}>
                <Text style={{ color: COLORS.textHeader, fontSize: RFValue(16), ...FONTS.lexendsemibold, alignItems: "flex-start" }}>Price Details</Text>
                <View style={{ borderBottomColor: "#616161", borderBottomWidth: 2, alignItems: "flex-start", marginTop: "3%" }} />
                ...
                <View style={{ borderBottomColor: "#616161", borderBottomWidth: 2, alignItems: "flex-start" }} />
                <View style={{ width: horizontalScale(310)}}>
                    <View style={{ flexDirection: "row", paddingBottom: "2%", alignItems: "center" }}>
                        <View style={{ width: "80%", alignItems: "flex-start",marginTop: "3%"}}>
                            <Text style={{ color: COLORS.gray, fontSize: RFValue(13), ...FONTS.lexendregular }}>Total Amount</Text>
