        ...
        <View
          ...
          <View style={{ flexDirection: 'row', alignItems: "center" }}>
            ...
            <View style={{ marginTop: "4%", flexDirection: 'row', justifyContent: "center" }}>
              <Text style={{ color: "white", fontSize: 20, marginLeft: "25%", bottom: 8 }}>Notifications</Text>
            </View>
          </View>
        </View>
              ...
              <View style={{ padding: '3%' }}>
                <TouchableOpacity style={{ backgroundColor: "white",borderRadius:5,elevation:1, flexDirection: "row",padding:"1%" }}>
                  ...
                  <View style={{ flexDirection: "column", width: "70%" }}>
                    ...
                    <Text style={{fontSize:16,fontWeight:"bold",margin:"2%"}}>{item.from}</Text>
                    <Text style={{fontSize:14,fontWeight:"200",margin:"2%"}}>{item.to}</Text>
                    <Text style={{fontSize:14,fontWeight:"200",marginTop:"3%"}}>{item.date}</Text>
