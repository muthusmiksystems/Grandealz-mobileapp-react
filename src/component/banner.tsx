...
const Banner = (data) => {
  ...
  // console.log(banner, "im the banner page");
            ...
            <View style={{ backgroundColor: "#070022", borderRadius: 8, marginHorizontal: "1%" }}>
              <View style={{ marginVertical: "11.5%", marginHorizontal: "5%", flexDirection: "row", justifyContent: "space-between" }}>
                <View style={{ flexDirection: "column", width: "65%" }}>
                  <Text style={{ color: "white", fontSize: moderateScale(6), ...FONTS.lexendregular }}></Text>
                  ...
                  <TouchableOpacity style={{ borderWidth: 1, borderRadius: 8, borderColor: "white", marginTop: "6%", width: "50%", height: "20%" }} onPress={() => { { banner[0].btn_url } }}>
                    <Text style={{ color: "white", fontSize: moderateScale(12), ...FONTS.lexendregular, textAlign: "center", padding: "3%" }}>{banner[0].btn_text}</Text>
                  </TouchableOpacity>
                </View>
            ...
            <View style={{ backgroundColor: "#070022", borderRadius: 8, marginHorizontal: "1%" }}>
              <View style={{ marginVertical: "11.5%", marginHorizontal: "5%", flexDirection: "row", justifyContent: "space-between" }}>
                <View style={{ flexDirection: "column", width: "65%" }}>
                  ...
                  <Text style={{ color: "white", fontSize: moderateScale(13), ...FONTS.lexendregular }}>{banner[1].title} </Text>
                ...
                <View style={{ width: "35%", flexDirection: "column", right:10,borderWidth: 2 }}>
                  <Image
